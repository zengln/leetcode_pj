...
class Solution:
    def romanToInt(self, s: str) -> int:
        temp_dict = {"I": 1, "V": 5, "X": 10, "L": 50, "C": 100, "D": 500, "M": 1000, "IV": 4, "IX": 9, "XL": 40, "XC": 90,
                "CD": 400, "CM": 900}
        index = 0
        num = 0
        while index < len(s):
            if index < len(s) - 1 and s[index:index+2] in temp_dict:
                num += temp_dict.get(s[index:index+2])
                index += 2
            else:
