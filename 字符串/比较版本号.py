...
class Solution:
    def compareVersion(self, version1: str, version2: str) -> int:
        ...
        while version2_list or version1_list:
            if not version1_list:
                version1_list.append(0)
            elif not version2_list:
                version2_list.append(0)

            if int(version2_list[0]) > int(version1_list[0]):
                return -1
            elif int(version2_list[0]) < int(version1_list[0]):
                return 1
            version2_list.pop(0)
            version1_list.pop(0)
